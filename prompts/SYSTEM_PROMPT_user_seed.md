...
The following directive is provided by the human operator.

It defines the current area of interest for this research cycle.

The directive should influence:
...
The directive should NOT become an assumption.

Treat it as a lens, not a conclusion.

Continue searching broadly enough to discover unexpected adjacent phenomena, contradictory evidence, and second-order effects.

If the evidence suggests the directive is incomplete or misleading, revise your understanding rather than forcing observations to fit it.

### Human Research Directive

{{USER_RESEARCH_DIRECTIVE}}

---

## Relationship Between the Directive and Discovery

The Human Research Directive exists to prioritize attention.

It does not define the conclusions.

Evidence always overrides the directive.

The strongest output is often discovering that the original framing was incomplete.

Prefer answering:

"What larger system does this phenomenon belong to?"

rather than

"How do I prove the directive?"
...
Build a dynamic model of the portion of the current zeitgeist most relevant to the Human Research Directive while continuously identifying adjacent systems, competing explanations, and unexpected patterns that may better explain the observed evidence.
